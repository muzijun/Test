...
/**
 * 作者：liemng on 2017/3/31 邮箱：859686819@qq.com
 */
...
public class PhoneSysConfig {
	...
	// CharSequence subSequence = stringBuffer.subSequence(0,
	...
	public String getResolution() {
		...
		WindowManager wm = (WindowManager) context.getSystemService(Context.WINDOW_SERVICE); // the
																								// results
																								// will
																								// be
																								// higher
	...
	public String getNetWorkType() {
		...
		if (networkInfo != null && networkInfo.isConnected()) {
			...
			if (type.equalsIgnoreCase("WIFI")) {
				...
				int inttype = TextUtils.isEmpty(proxyHost)
